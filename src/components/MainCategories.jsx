...
export const MainCategories = () => {
  return (
    <div className='hidden md:flex flex-wrap bg-white rounded-3xl xl:rounded-full p-4 shadow-lg items-center justify-center gap-8'>
        {/* links */}    
        ...
        <div className="bg-gray-100 p-2 rounded-full flex items-center gap-2">
            ...
            <input type="text" placeholder="Buscar un artículo" className="bg-transparent"/>
        </div>
    </div>
  )
}
